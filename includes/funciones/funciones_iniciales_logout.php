...
<!--Hoja de estilos del calendario -->
  <link rel="stylesheet" type="text/css" media="all" href="../../../js/jscalendar-1.0/calendar-green.css"    title="win2k-cold-1" />
...
echo '</head>
<body topmargin="0" leftmargin="0"  style="margin: 0px; padding: 0px"  onload="MM_preloadImages(\'../../images/b_enviar_on.gif\')"  >';
?>
