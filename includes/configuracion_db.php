...
define('DB_SERVIDOR', '10.156.80.102');//dirección del servidor de base de datos
define('DB_SERVIDOR_PUERTO', '3306');// puerto de conexión de base de datos
define('DB_SERVIDOR_USERNAME', 'root');//usuario de conexión de base de datos
define('DB_SERVIDOR_PASSWORD', '*Seniat');//Contraseña de conexión de base de datos
