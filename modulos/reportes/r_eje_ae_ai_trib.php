...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->SetY(10);$this->SetX(1);$this->Cell(10,0,'Nombre del Proyecto: Sistema Tributario Socialista - Segunda Fase Fortalecimiento.');
		$this->SetY(13);$this->SetX(1);$this->Cell(10,0,'Directriz: Modelo Productivo Socialista.');
		$this->SetY(16);$this->SetX(1);$this->Cell(10,0,'Objetivo: Desarrollar el nuevo modelo productivo endógeno como base económica del Socialismo del Siglo XXI y alcanzar un crecimiento sostentivo.');
		$this->SetY(19);$this->SetX(1);$this->Cell(10,0,'Estrategia: Consolidar el carácter endógeno de la economía.');
		$this->SetY(22);$this->SetX(1);$this->Cell(10,0,'Objetivo Estratégico Institucional: Reordenar el Sist. Tributario a la concepción Socialista del Estado Venezolano para garantizar estructuras impositivas que distribuyan a la carga en función del esfuerzo humano productivo, req. para generar la riqueza.');
		
		$this->SetY(25);$this->SetX(1);$this->Cell(10,0,'Objetivo Específico del Proyecto: Desarrollar un Sistema Integral de Cobranza y Control Fiscal.');
