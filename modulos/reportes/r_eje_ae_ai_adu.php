...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->SetY(10);$this->SetX(1);$this->Cell(10,0,'Nombre del Proyecto: Sistema Aduanero Socialista - Segunda Fase Fortalecimiento.');
		$this->SetY(13);$this->SetX(1);$this->Cell(10,0,'Directriz: Nueva Geopolítica Internacional.');
		$this->SetY(16);$this->SetX(1);$this->Cell(10,0,'Objetivo: Fortalecer la soberanía nac. vigorizando y ampliando las alianzas orientadas a la conformación del bloque geopolítico regional de un mundo multipolar.');
		$this->SetY(19);$this->SetX(1);$this->Cell(10,0,'Estrategia: Mantener relaciones soberanas ante el bloque hegemónico mundial.');
		$this->SetY(22);$this->SetX(1);$this->Cell(10,0,'Objetivo Estratégico Institucional: Reordenar el Sist. Aduanero a la concepción Socialista del Estado Venezolano para promover y proteger el modelo de desarrollo Socialista.');
		
		$this->SetY(25);$this->SetX(1);$this->Cell(10,0,'Objetivo Específico del Proyecto: Fortalecer la capacidad del Servicio Aduanero para la seguridad y defensa nacional, protección y preservación de la vida, el ambiente, la sociedad y la economía nacional.');
		$this->SetY(26);$this->SetX(1);
		...
		$this->SetY(30);$this->SetX(1);
		$this->Cell(60,4,'Acción Específica / Acción Intermedia',0,0,'L',1);
		$this->SetY(34);$this->SetX(1);
		$this->Cell(66,4,'Unidad de Medida ',0,0,'L',1);
		$this->SetY(34);$this->SetX(67);$this->Cell(20,4,'Ene.',0,0,'L',1);
		$this->SetY(34);$this->SetX(84);
		$this->Cell(20,4,'Feb.',0,0,'L',1);
		$this->SetY(34);$this->SetX(101);
		$this->Cell(20,4,'Mar.',0,0,'L',1);
		$this->SetY(34);$this->SetX(118);
		$this->Cell(20,4,'Abr.',0,0,'L',1);
		$this->SetY(34);$this->SetX(135);
		$this->Cell(20,4,'May.',0,0,'L',1);
		$this->SetY(34);$this->SetX(152);
		$this->Cell(20,4,'Jun.',0,0,'L',1);
		$this->SetY(34);$this->SetX(169);
		$this->Cell(20,4,'Jul.',0,0,'L',1);
		$this->SetY(34);$this->SetX(186);
		$this->Cell(20,4,'Ago.',0,0,'L',1);
		$this->SetY(34);$this->SetX(203);
		$this->Cell(20,4,'Sep.',0,0,'L',1);
		$this->SetY(34);$this->SetX(219);
		$this->Cell(20,4,'Oct.',0,0,'L',1);
		$this->SetY(34);$this->SetX(236);
		$this->Cell(20,4,'Nov.',0,0,'L',1);
		$this->SetY(34);$this->SetX(252);
		$this->Cell(20,4,'Dic.',0,0,'L',1);
		$this->SetY(34);$this->SetX(266);
	...
	$Y_Fields_Name_position = 20;
		...
		if (!$grupo_eje ->EOF)
		{
			...
			$pdf->SetY(27);$pdf->SetX(1);$pdf->Cell(40,3,'Unidad Ejecutora: '.$grupo_eje ->fields['descripcion'],0,0,'L');	
