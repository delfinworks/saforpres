...
class ADODB_mysql extends ADOConnection {
	...
	var $clientFlags = 131072;//CLIENT_MULTI_RESULTS  131072
	...
	/*Modificación para setear los flags*/
	function getclientFlags(){
		return $this->clientFlags;
	}
	function setclientFlags($clientFlags){
...
//		return "from_unixtime(unix_timestamp($date)+$fraction)";
	...
	function _connect($argHostname, $argUsername, $argPassword, $argDatabasename)
	{
		...
		if (ADODB_PHPVER >= 0x4300)
			...
			$this->_connectionID = mysql_connect($argHostname,$argUsername,$argPassword,
												$this->forceNewConnect,null,$this->clientFlags);
		else
			$this->_connectionID = mysql_connect($argHostname,$argUsername,$argPassword,null,$this->clientFlags);
